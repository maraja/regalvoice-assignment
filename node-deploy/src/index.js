...
const deploymentDir = process.cwd()//"./"//process.argv[2];
...
const getFullDate = () => format(new Date(), "yyyMMddHHmmss");
...
(async () => {
    ...
    // check to see if there is any other deployments happening
    // if code-deploy is running as another instance, there will
    // be a deploy.lock file to stop it as these directories rely on
    // each other for dependencies and such.
